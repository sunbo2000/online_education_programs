          ...
          <tr class="good">
            <td class="name First">
              ...
              <div class="goodInfo">
                ...
                <a target="_blank" :href="'https://localhost:3000/course/'+
order.courseId">{{order.courseTitle}}</a>
      ...
      <div class="Finish">
        <div class="fr" id="AgreeDiv">
          <label for="Agree">
            <p class="on"><input type="checkbox" checked="checked">我已阅读并同意<a href="javascript:" target="_blank">《谷粒学院购买
                协议》</a></p>
          </label>
        </div>
        <div class="clear"></div>
...
export default {
  ...
  asyncData({ params, error }) {
    return order.getOrderinfo(params.orderNo).then(response => {
      return {
