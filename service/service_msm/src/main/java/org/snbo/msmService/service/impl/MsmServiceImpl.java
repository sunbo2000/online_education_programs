package org.snbo.msmService.service.impl;
...
import org.snbo.msmService.utils.ConstantPropertiesUtils;
...
public class MsmServiceImpl implements MsmService {
    ...
    public void sendMessage(String phoneNum, Map<String, String> param) {
        try {
            // 创建凭据
            ...
            req.setSmsSdkAppId(ConstantPropertiesUtils.SDK_APP_ID);
            ...
            String[] templateParamSet = {param.get("code"), param.get("time")};
            ...
            e.printStackTrace();
            throw new MoguException(20001, "短信发送失败,请稍后再试");
        }
    }
}
