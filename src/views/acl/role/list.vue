<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column prop="roleName" width="600" align="center" label="角色名称" />


      <el-table-column label="操作" align="center">
        <template slot-scope="scope">
          <router-link :to="'/acl/role/distribution/'+scope.row.id">
            <el-button type="info" size="mini" icon="el-icon-info" v-if="hasPerm('role.acl')">权限修改</el-button>
          </router-link>
          <router-link :to="'/acl/role/update/'+scope.row.id">
            <el-button type="primary" size="mini" icon="el-icon-edit"  v-if="hasPerm('role.update')">名称修改</el-button>
          </router-link>
